    ...
    <div className='pb-[100px]'>
        ...
        <div className='flex-col h-full items-center justify-center w-full relative overflow-hidden '>
            ...
            <div className='flex flex-col px-6 gap-5 justify-center max-w-7xl mx-auto'>
                ...
                <div className='pt-[50px] max-w-[900px] w-full grid grid-cols-1 sm:grid-cols-6 lg:grid-cols-10 gap-x-5 gap-y-5'>
                    <div className='w-full gap-4 col-span-1 sm:col-span-3 lg:col-span-5 flex flex-col px-10 py-10 border-[#F5886C] border-[1px] rounded-[7px]'>
                        <p className='font-bold text-xl text-[#393939]'>Direito do Consumidor</p>
                        <ul className=''>
                    ...
                    <div className='col-span-1 gap-4 sm:col-span-3 lg:col-span-5 bg-white z-50 flex items-start justify-center flex-col px-10 py-10 border-[#F5886C] border-[1px] rounded-[7px]'>
                        <p className='font-bold text-xl text-[#393939] text-left'>Direito à Saúde</p>
                        <ul className=''>
                    ...
                    <div className='col-span-1 gap-4 sm:col-span-3 lg:col-span-4 flex flex-col px-10 py-10 border-[#F5886C] border-[1px] rounded-[7px]'>
                        <p className='font-bold text-xl text-[#393939]'>Direito Civil</p>
                        <ul className=''>
                    ...
                    <div className='col-span-1 gap-4 sm:col-span-3 lg:col-span-5 bg-white z-50 flex flex-col  px-10 py-10 border-[#F5886C] border-[1px] rounded-[7px]'>
                        <p className='font-bold text-xl text-[#393939]' >Direito de Família e Sucessões</p>
                        <ul className=''>
                    ...
                    <div className='col-span-1 gap-4 sm:col-span-2 lg:col-span-5 flex flex-col px-10 py-10 border-[#F5886C] border-[1px] rounded-[7px]'>
                        <p className='font-bold text-xl text-[#393939]'>Direito Previdenciário</p>
                        <ul className=''>
                    ...
                    <div className=' sm:col-span-4 gap-4 lg:col-span-5 flex bg-white z-50 flex-col  px-10 py-10 border-[#F5886C] border-[1px] rounded-[7px]'>
                        <p className='font-bold text-xl text-[#393939]'>Direito Trabalhista</p>
                        <ul className=''>
